      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="body-lg text-muted-foreground max-w-2xl mx-auto">
                Discover our complete range of premium athletic wear designed for every sport and lifestyle.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <div>
                ...
                <p className="body-md text-muted-foreground">Handpicked essentials for peak performance</p>
              </div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="heading-lg mb-4">Free Shipping on Orders Over $75</h2>
              <p className="body-lg mb-8 text-primary-foreground/90">
                Get your gear delivered fast with complimentary shipping on qualifying orders. No code needed, discount
                applied at checkout.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <div>
                ...
                <p className="body-md text-muted-foreground">The latest innovations in athletic performance</p>
              </div>
              <Button variant="outline" asChild>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="body-lg mb-6 text-muted-foreground">
                  At Athleon, we believe that every athlete deserves gear that matches their dedication. Our premium
                  athletic wear is engineered with cutting-edge materials and innovative design to help you perform at
                  your peak.
                </p>
                <p className="body-md mb-8 text-muted-foreground">
                  From moisture-wicking fabrics to ergonomic fits, every detail is crafted to enhance your performance
                  and comfort, whether you're training for your next PR or conquering everyday challenges.
                </p>
                <Button asChild>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="body-lg text-muted-foreground max-w-2xl mx-auto">
                Join thousands of athletes who trust Athleon for their performance needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <p className="body-md text-muted-foreground">Satisfaction Rate</p>
              </div>
              <div>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="heading-lg mb-4">Stay Ahead of the Game</h2>
            <p className="body-lg mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
              Be the first to know about new drops, exclusive offers, and training tips from our athletes.
            </p>
